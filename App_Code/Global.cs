...
public static class Global
{
 ...
 //   static string _slidepath = @"http://pictures.kreatewebsites.com/slide16/";
    static string _slidepath = @"http://pictures.kreatewebsites.com/banner/" ;
...
static string _Keyword = "Karwa Choth";
 ...
 public static class Gallery
 {
  ...
  static string _photoviewer = @"photoviewer.php";
