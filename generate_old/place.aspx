...
<asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%# DataBinder.Eval(Container.DataItem, "biz_name", "http://www.kreatewebsites.com/attraction-details.aspx?name={0}") %>' class="readmore"><span>See More pictures</span></asp:HyperLink> 
