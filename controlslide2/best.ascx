								...
								<div id="banner">
									...
									<div class="caption">
										...
										<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%#Eval("link") %>' class="button">Australia Cities</asp:HyperLink> 
                                         ...
                                         <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="http://www.kreatewebsites.com/tourist-attractions.aspx" class="button">Tourist Attractions</asp:HyperLink>   
									</div>
                               </div>
							</div>
						</div>
